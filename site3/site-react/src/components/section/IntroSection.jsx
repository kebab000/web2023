...
const introTitle = {
    ...
    sub: 'Portfolio',
    img: '../../assets/images/member/member106.svg',
    imgAlt: 'member106',
};

const introText = [
    {
        link: 'https://kebab00.tistory.com/',
        iconClass: 'icon-bg1',
        title: 'Tistory',
        desc: '수업을 시작하면서 개설한 Tistory 블로그 입니다. 그동안 배운 것들을 모두 정리하고 복습한 사이트이며 HTML, CSS, PHP, JavaScript, Programmers등이 정리되어 있습니다.',
    },
    {
        link: 'https://github.com/kebab000/',
        iconClass: 'icon-bg2',
        title: 'Github',
        desc: 'GitHub은 분산 버전 관리 시스템인 Git을 기반으로 하는 웹 기반 호스팅 서비스입니다. 개발자들은 Git을 사용하여 소스 코드를 추적하고 변경사항을 관리할 수 있으며, GitHub을 통해 이러한 코드를 온라인으로 저장, 공유 및 협업할 수 있습니다. 수업시간에 했던 모든 것이 저장되어 있습니다.',
    },
    {
        link: 'https://kebab000.github.io/web2023/',
        iconClass: 'icon-bg3',
        title: 'JavaScript',
        desc: '수업의 기초가 되었던 JavaScript사이트 입니다. 가장 기초부터 시작해서 다양한 메서드까지 수업시간에 했던 모든 예제들이 올라가 있습니다.',
    },
    {
        link: 'http://kebab00.dothome.co.kr/php2/index.html',
        iconClass: 'icon-bg4',
        title: 'PHP',
        desc: '조별과제로 만든 php사이트입니다. Planty라는 사이트로 식물관리에 대한 정보를 제공하며 자기의 식물을 저장하고 커뮤니티를 통해 공유할 수 있습니다.',
    },
];
function IntroDesc({ iconClass, title, desc, link }) {
    return (
        <div>
            <a href={link}>
            ...
            <div className="intro__inner container">
                <div className="intro__title">
                    ...
                    <figure className="myCharacter">
                        <img src={introTitle.img} alt={introTitle.imgAlt} />
                    </figure>
                    <>{introTitle.title}</>
                    <>{introTitle.desc}</>
                </div>
